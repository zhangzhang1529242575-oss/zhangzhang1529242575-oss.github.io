...
**1. Enhanced Sliding Mode Control for PMSM Speed Drive Systems Using a Novel Adaptive Sliding Mode Reaching Law Based on Exponential Function**
...
- **作者**：**Zhang Zhang**, Mingyuan Jiang, Zixu Dong, Zhouyang Zhang, Shuangxia Niu, K.T. Chau
- **期刊**：*IEEE Transactions on Magnetics*, 2026
- **DOI**：[10.1109/TMAG.2026.3698454](https://doi.org/10.1109/TMAG.2026.3698454)
- **贡献**：提出集成绕组双转子 PMSM 的解耦电流变换控制方法，实现单逆变器驱动的双转子独立控制

### 会议论文

**4. Sliding Mode Control of Permanent Magnet Linear Synchronous Motors Based on an Adaptive Sliding Mode Reaching Law**

- **作者**：**Zhang Zhang**, Z. Nie, J. An, Kaiwen Chen, Jianfei Pan
